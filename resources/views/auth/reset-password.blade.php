                  ...
                  <div class="col-md-10">
                     <div class="d-flex justify-content-center mb-0">
                        ...
                        <a>
                           ...
                           <br>
                           <h3 class="mb-2 text-center">Reset Password</h3>
                           ...
                           <div class="row text-start">
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    ...
                                    <x-jet-input id="email" class="form-control my-cart-card border border-primary rounded" type="email" aria-describedby="email"  name="email" :value="old('email', $request->email)" required autofocus />
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="floating-label form-group">
                              ...
                              <div class="floating-label form-group">
                               ...
                               <div class="d-flex justify-content-center">
                                 <x-jet-button type="submit" class="btn btn-primary rounded-pill">{{ __('Reset Password') }}</x-jet-button>
                              </div>
                           </form>
                        </div>
                     </div>
