                           ...
                           <div class="row text-start">
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    ...
                                    <x-jet-input id="email" class="form-control my-cart-card border border-primary rounded" type="email" aria-describedby="email"  name="email" :value="old('email')" required autofocus />
                                 </div>
                              </div>
                           </div>
                                 <x-jet-button type="submit"  class="btn btn-primary rounded-pill">{{ __('Email Password Reset Link') }}  </x-jet-button>
                           </form>
                        </div>
                     </div>
                  </div>
