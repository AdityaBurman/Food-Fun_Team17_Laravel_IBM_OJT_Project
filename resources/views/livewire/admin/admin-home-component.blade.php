         ...
         <div class="col-lg-12">
            <div class="iq-main">
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between mx-3 my-3">
                     <div class="d-flex flex-wrap align-items-center">
                        <div class="profile-img22 position-relative me-3 mb-3 mb-lg-0">
                           <img src="{{asset('foodfun/html/assets/images/User-profile/1.png')}}" class="img-fluid avatar avatar-100 avatar-rounded" alt="profile-image">
                        </div>
                        <div class="d-flex align-items-center mb-3 mb-sm-0">
                           <div>
                              <h6 class="me-2 text-primary">Aditya Burman</h6>
                              <span><svg width="19" height="19" class="me-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 </svg><small class="mb-0 text-dark">Bilaspur, Chhattisgarh</small></span>
                           </div>
                           <div class="ms-4">
                              <p class="mb-0 text-dark">Student</p>
                              <p class="me-2 mb-0 text-dark">demo@gmail.com</p>
               ...
               <div class="iq-header-img">
                  <img src="{{asset('foodfun/html/assets/images/User-profile/01.png')}}" alt="header" class="img-fluid w-100 rounded" style="object-fit: contain;">
               </div>
            </div>
         </div>
...
<div class="content-inner mt-5 py-0">
        <div class="row">
         ...
         <div class="hero-image p-3" style="background: url({{asset('foodfun/html/assets/images/layouts/01.png')}}) no-repeat center right;background-size: cover;background-position: center;">
               ...
               <div class="swiper-wrapper">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/1.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/2.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/3.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/4.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/5.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/6.png" alt="header" class="img-fluid rounded-pill mb-3">
                  ...
                  <div class="swiper-slide">
                     ...
                     >
                        <div class="card-body">
                           <div class="text-center iq-menu-category">
                              <img src="foodfun/html/assets/images/layouts/7.png" alt="header" class="img-fluid rounded-pill mb-3">
            ...
            <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
               <div class="row row-cols-1 row-cols-md-2 row-cols-xl-2 row-cols-xxl-4">
                  ...
                  >
                     <div class="card card-white dish-card profile-img mb-0">
                         <div class="profile-img21">
                             <img src="foodfun/html/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="foodfun/html/assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                             data-iq-gsap="onStart"
                             data-iq-opacity="0"
                             data-iq-scale=".6"
                             data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card profile-img mb-0">
                         <div class="profile-img21">
                             <img src="foodfun/html/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="foodfun/html/assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                             data-iq-gsap="onStart"
                             data-iq-opacity="0"
                             data-iq-scale=".6"
                             data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card profile-img mb-0">
                         <div class="profile-img21">
                             <img src="foodfun/html/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="foodfun/html/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                             data-iq-gsap="onStart"
                             data-iq-opacity="0"
                             data-iq-scale=".6"
                             data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card profile-img mb-0">
                         <div class="profile-img21">
                             <img src="foodfun/html/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom"
                                 alt="profile-image">
                             <img src="foodfun/html/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 hover-image " alt="profile-image"
                             data-iq-gsap="onStart"
                             data-iq-opacity="0"
                             data-iq-scale=".6"
                             data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="foodfun/html/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="foodfun/html/assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="foodfun/html/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="foodfun/html/assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="foodfun/html/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="foodfun/html/assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="foodfun/html/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="foodfun/html/assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
                  ...
                  >
                     <div class="card card-white dish-card2 index">
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="foodfun/html/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="foodfun/html/assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
                         ...
                         <div class="card-body ">
                             <div class="d-flex profile-img1">
                                 <div class="profile-img31">
                                     <img src="../foodfun/html/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image">
                                     <img src="../foodfun/html/assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 hover-image" alt="profile-image"
                                     data-iq-gsap="onStart"
                                     data-iq-opacity="0"
                                     data-iq-scale=".6"
                                     data-iq-rotate="180"
               ...
               <div class="card-body">
                  <div class="text-center profile-img51">
                     <div class="profile-img41 ">
                        <img src="../foodfun/html/assets/images/layouts/8.png" class="img-fluid rounded-pill " alt="profile-image">
                     </div>
               ...
               <div class="card-body">
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4">
                        <div class="profile-img11">
                           <img src="../foodfun/html/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="../foodfun/html/assets/images/layouts/13.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                           data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="../foodfun/html/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="../foodfun/html/assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                           data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                  ...
                  <div class="rounded-pill bg-soft-primary iq-my-cart">
                     <div class="d-flex align-items-center justify-content-between profile-img4 mt-4">
                        <div class="profile-img11">
                           <img src="../foodfun/html/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115 blur-shadow position-end" alt="img">
                           <img src="../foodfun/html/assets/images/layouts/11.png" class="img-fluid rounded-pill avatar-115"  alt="img"
                           data-iq-gsap="onStart"
                           data-iq-opacity="0"
                           data-iq-scale=".6"
                           data-iq-rotate="180"
                  ...
                  <div class="text-center mt-5">
                     <a type="button" href="../foodfun/html/dashboard/special-pages/add-to-cart.html" class="btn btn-primary rounded-pill">Checkout</a>
                  </div>   
               </div>
            </div>
         </div>
            ...
            >
               ...
               <div class="card-body">
                  <div class="iq-col-masonry m-0">
                     <button type="button" class="btn btn-outline-primary rounded iq-col-masonry-block">Burgers</button>
             ...
             <div class="position-relative">
                  <img src="../foodfun/html/assets/images/layouts/40.png" alt="img-1" class="img-fluid img-user">
               </div>
         </div>
      </div>
   </div>
