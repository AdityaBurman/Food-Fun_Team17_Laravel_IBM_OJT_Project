            ...
            <div class="card my-cart-card border border-primary rounded p-3 mt-5">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Edit Food Details</h4>
                ...
                <div class="card-body ">
                    ...
                    <form wire:submit.prevent="updateProduct">
                      ...
                      <div class="form-group">
                        <label class="form-label " for=""> Food Image</label><br>
                      
                        @if($newimage)
                        <img class="avatar-100 rounded-pill" src="{{$newimage->temporaryURL()}}" alt=""><br>
                        @else
                        <img class="avatar-100 rounded-pill" src="{{asset('User1/images/products')}}/{{$image}}" alt=""><br>
               
                        <input class="form-control my-cart-card border border-primary rounded" type="file" id="newimage" name="newimage"  wire:model="newimage">
