               ...
               <div class="row banner-container ">
                  <div class="col-lg-12 banner-item">
                     <span class="text-primary d-flex justify-content-center align-items-center">
                        <svg width="35" height="40" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h4 class="text-primary">Food & Fun </h4>
...
<div class="row mt-12">
    ...
    <div class="col-md-12">
    <div>
    <h4 class="list-main d-flex justify-content-center">Your Favourite Food Items</h4>

    </div><br>
        <div class="card table-responsive my-cart-card border border-primary rounded ">
            <table class="table table-borderless product-table rounded">
                <thead class="bg-primary">
                    <tr>
                        <th><span class="heading-title rowpad text-white">Food Items</span></th>
                        <th><span class="heading-title rowpad text-white">Move to Cart</span></th>
                    </tr>
                </thead>
                    ...
                    <tr class="cart_item border-bottom">
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="{{asset('User1/images/products')}}/{{$item->model->image}}" class="img-fluid avatar-rounded avatar-70" alt="profile-image">
                                <div class="d-flex ms-3">
                                    <div>
                                        <!--<h6 class="heading-title text-primary">Main Course</h6>-->
                                        <p class="mb-0 fw-bolder">{{$item->model->name}}</p>
                                        </p>
                                        <div class="d-flex mb-2 mt-3">
                                            
                                            <small class="ms-5 text-primary">₹ {{$item->model->regular_price}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
				...
				@endforeach
							@else
                            <br>   <h4 class="list-main d-flex justify-content-center">No Food in your Wishlist</h4><br>
