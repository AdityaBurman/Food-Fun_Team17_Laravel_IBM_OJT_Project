...
<div class="col-lg-12">
         ...
         <div class="col-lg-12">
               ...
               <div class="card my-cart-card border-primary mb-10 p-3 mt-5 iq-content3 rounded-center my-cart-card border border-primaryp-3">
                  <div class="d-flex flex-wrap align-items-center justify-content-between mx-3 my-3">
                     ...
                     <small class=""><p class="mb-0 text-dark"> <a href="{{route('user.editprofile')}}" class="btn btn-primary rounded-pill pull-right">Update Profile</a> </p><br> <p class="mb-0 text-dark"> <a href="{{route('user.changepassword')}}" class="btn btn-primary rounded-pill pull-right">Change Password</a> </p></small>  
            ...
            <div class="col-md-6">
               <div class="card my-cart-card border border-primary rounded p-3 mt-5 bg-soft-primary">
                  <div class="card-body">
            ...
            <div class="col-md-6">
               <div class="card my-cart-card border border-primary rounded p-3 mt-5 bg-soft-info">
                  <div class="card-body">
                     <div class="d-flex justify-content-between">
                        <div>
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="card my-cart-card border border-primary rounded p-3 mt-5 bg-soft-orange">
                  <div class="card-body">
                     <div class="d-flex justify-content-between">
                        <div>
            ...
            <div class="card-body px-0">
               <div class="table">
                  <div id="user-list-table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive my-3"><table id="user-list-table" class="table table-striped dataTable no-footer" role="grid" data-toggle="data-table" aria-describedby="user-list-table_info">
                     ...
                     <tr class="">
                           <td><span class="badge bg-primary"> {{$order->id}} </td>
                           <td> {{$order->created_at}} </td>
                          
                           <td> {{$order->total}} </td>
                           <td><span class="badge bg-success"> {{$order->status}} </td>
